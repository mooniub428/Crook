package com.example.stath.crookclient.Connection;
...
public class Post_Request_Handler {
    ...
    public String performPostCall(String requestURL, HashMap<String, String> postDataParams,
                                  boolean customPost, String customPostData){
        ...
        try{
            ...
            if(!customPost) {
                ...
                Log.d(TAG, "customPostData" + customPostData);
                writer.write(customPostData);
